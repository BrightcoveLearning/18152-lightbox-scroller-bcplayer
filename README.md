...
# 18152-lightbox-scroller-bcplayer
For more information about this sample see: https://support.brightcove.com/brightcove-player-sample-lightbox-scroller.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>lightbox-scroller.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/plugin-name.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>lightbox-scroller.css</strong>.</td>
    </tr>
  </tbody>
</table>
